...
public class HoleriteItem {

private Long seqHoleriteItem;
...
private Long seqHolerite;
private String codigoHolerite;
private String eventoCodigo;
private String eventoNome;
private String eventoReferencia;
private String eventoOperacao;
private BigDecimal valor;

// Criar GETs e SETs

    public Long getSeqHoleriteItem() {
        return seqHoleriteItem;
    }

    public void setSeqHoleriteItem(Long seqHoleriteItem) {
        this.seqHoleriteItem = seqHoleriteItem;
    }
    ...
    public Long getSeqHolerite() {
        return seqHolerite;
    }

    public void setSeqHolerite(Long seqHolerite) {
        this.seqHolerite = seqHolerite;
    }

    public String getCodigoHolerite() {
        return codigoHolerite;
    }

    public void setCodigoHolerite(String codigoHolerite) {
        this.codigoHolerite = codigoHolerite;
    }
    ...
    public String getEventoReferencia() {
        return eventoReferencia;
    }

    public void setEventoReferencia(String eventoReferencia) {
        this.eventoReferencia = eventoReferencia;
    }

    public String getEventoOperacao() {
        return eventoOperacao;
    }

    public void setEventoOperacao(String eventoOperacao) {
        this.eventoOperacao = eventoOperacao;
    }
