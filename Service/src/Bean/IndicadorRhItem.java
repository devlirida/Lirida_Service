...
public class IndicadorRhItem {

    private Long seqIndicadorRhItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorRh;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorRhItem() {
        return seqIndicadorRhItem;
    }

    public void setSeqIndicadorRhItem(Long seqIndicadorRhItem) {
        this.seqIndicadorRhItem = seqIndicadorRhItem;
    }
    ...
    public String getCodigoIndicadorRh() {
        return codigoIndicadorRh;
    }

    public void setCodigoIndicadorRh(String codigoIndicadorRh) {
        this.codigoIndicadorRh = codigoIndicadorRh;
    }
