...
private Long seqFilaPedidoVenda;
...
private List<FilaPedidoVendaItem>listaItem;

// Criar GETs e SETs

    public Long getSeqFilaPedidoVenda() {
        return seqFilaPedidoVenda;
    }

    public void setSeqFilaPedidoVenda(Long seqFilaPedidoVenda) {
        this.seqFilaPedidoVenda = seqFilaPedidoVenda;
    }
    ...
    public List<FilaPedidoVendaItem> getListaItem() {
        return listaItem;
    }

    public void setListaItem(List<FilaPedidoVendaItem> listaItem) {
