...
public class IndicadorTiItem {

    private Long seqIndicadorTiItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorTi;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorTiItem() {
        return seqIndicadorTiItem;
    }

    public void setSeqIndicadorTiItem(Long seqIndicadorTiItem) {
        this.seqIndicadorTiItem = seqIndicadorTiItem;
    }
    ...
    public String getCodigoIndicadorTi() {
        return codigoIndicadorTi;
    }

    public void setCodigoIndicadorTi(String codigoIndicadorTi) {
        this.codigoIndicadorTi = codigoIndicadorTi;
    }
