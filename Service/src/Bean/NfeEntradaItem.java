...
public class NfeEntradaItem {

    private Long seqNfeEntradaItem;
    private Long seqNfeEntrada;
...
// Criar GETs e SETs
    public Long getSeqNfeEntradaItem() {
        return seqNfeEntradaItem;
    }

    public void setSeqNfeEntradaItem(Long seqNfeEntradaItem) {
        this.seqNfeEntradaItem = seqNfeEntradaItem;
    }

    public Long getSeqNfeEntrada() {
        return seqNfeEntrada;
    }

    public void setSeqNfeEntrada(Long seqNfeEntrada) {
        this.seqNfeEntrada = seqNfeEntrada;
    }
