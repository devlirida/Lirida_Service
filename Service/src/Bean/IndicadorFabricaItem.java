...
public class IndicadorFabricaItem {

    private Long seqIndicadorFabricaItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorFabrica;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorFabricaItem() {
        return seqIndicadorFabricaItem;
    }

    public void setSeqIndicadorFabricaItem(Long seqIndicadorFabricaItem) {
        this.seqIndicadorFabricaItem = seqIndicadorFabricaItem;
    }
    ...
    public String getCodigoIndicadorFabrica() {
        return codigoIndicadorFabrica;
    }

    public void setCodigoIndicadorFabrica(String codigoIndicadorFabrica) {
        this.codigoIndicadorFabrica = codigoIndicadorFabrica;
    }
