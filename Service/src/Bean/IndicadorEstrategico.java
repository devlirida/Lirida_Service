...
public class IndicadorEstrategico {
    ...
    private Long seqIndicadorEstrategico;
...
private List<IndicadorEstrategicoItem>listaItem;

// Criar GETs e SETs

    public Long getSeqIndicadorEstrategico() {
        return seqIndicadorEstrategico;
    }

    public void setSeqIndicadorEstrategico(Long seqIndicadorEstrategico) {
        this.seqIndicadorEstrategico = seqIndicadorEstrategico;
    }
    ...
    public List<IndicadorEstrategicoItem> getListaItem() {
        return listaItem;
    }

    public void setListaItem(List<IndicadorEstrategicoItem> listaItem) {
