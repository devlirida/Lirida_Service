...
public class ContasReceber {
    ...
    private List<ContasReceberItem> listaItem;

// Criar GETs e SETs

    public Long getSeqContasReceber() {
        return seqContasReceber;
    }

    public void setSeqContasReceber(Long seqContasReceber) {
        this.seqContasReceber = seqContasReceber;
    }
    ...
    public List<ContasReceberItem> getListaItem() {
        return listaItem;
    }

    public void setListaItem(List<ContasReceberItem> listaItem) {
