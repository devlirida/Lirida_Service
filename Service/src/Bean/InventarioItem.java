...
public class InventarioItem {
    ...
    private Long seqInventarioItem;
    private Long seqInventario;
...
// Criar GETs e SETs
    public Long getSeqInventarioItem() {
        return seqInventarioItem;
    }

    public void setSeqInventarioItem(Long seqInventarioItem) {
        this.seqInventarioItem = seqInventarioItem;
    }

    public Long getSeqInventario() {
        return seqInventario;
    }

    public void setSeqInventario(Long seqInventario) {
        this.seqInventario = seqInventario;
    }
