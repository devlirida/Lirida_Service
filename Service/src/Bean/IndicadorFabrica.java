...
public class IndicadorFabrica {
    ...
    private Long seqIndicadorFabrica;
...
private List<IndicadorFabricaItem>listaItem;

// Criar GETs e SETs

    public Long getSeqIndicadorFabrica() {
        return seqIndicadorFabrica;
    }

    public void setSeqIndicadorFabrica(Long seqIndicadorFabrica) {
        this.seqIndicadorFabrica = seqIndicadorFabrica;
    }
    ...
    public List<IndicadorFabricaItem> getListaItem() {
        return listaItem;
    }

    public void setListaItem(List<IndicadorFabricaItem> listaItem) {
