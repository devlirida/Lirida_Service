...
public class IndicadorEstoque {

private Long seqIndicadorEstoque;
...
private List<IndicadorEstoqueItem> listaItem;

// Criar GETs e SETs

    public Long getSeqIndicadorEstoque() {
        return seqIndicadorEstoque;
    }

    public void setSeqIndicadorEstoque(Long seqIndicadorEstoque) {
        this.seqIndicadorEstoque = seqIndicadorEstoque;
    }
    ...
    public List<IndicadorEstoqueItem> getListaItem() {
        return listaItem;
    }

    public void setListaItem(List<IndicadorEstoqueItem> listaItem) {
