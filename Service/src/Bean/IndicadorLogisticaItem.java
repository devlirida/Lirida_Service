...
public class IndicadorLogisticaItem {

    private Long seqIndicadorLogisticaItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorLogistica;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorLogisticaItem() {
        return seqIndicadorLogisticaItem;
    }

    public void setSeqIndicadorLogisticaItem(Long seqIndicadorLogisticaItem) {
        this.seqIndicadorLogisticaItem = seqIndicadorLogisticaItem;
    }
    ...
    public String getCodigoIndicadorLogistica() {
        return codigoIndicadorLogistica;
    }

    public void setCodigoIndicadorLogistica(String codigoIndicadorLogistica) {
        this.codigoIndicadorLogistica = codigoIndicadorLogistica;
    }
