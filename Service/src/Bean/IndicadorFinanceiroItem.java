...
public class IndicadorFinanceiroItem {

    private Long seqIndicadorFinanceiroItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorFinanceiro;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorFinanceiroItem() {
        return seqIndicadorFinanceiroItem;
    }

    public void setSeqIndicadorFinanceiroItem(Long seqIndicadorFinanceiroItem) {
        this.seqIndicadorFinanceiroItem = seqIndicadorFinanceiroItem;
    }
    ...
    public String getCodigoIndicadorFinanceiro() {
        return codigoIndicadorFinanceiro;
    }

    public void setCodigoIndicadorFinanceiro(String codigoIndicadorFinanceiro) {
        this.codigoIndicadorFinanceiro = codigoIndicadorFinanceiro;
    }
