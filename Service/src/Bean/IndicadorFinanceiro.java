...
public class IndicadorFinanceiro {
    ...
    private Long seqIndicadorFinanceiro;
...
// Criar GETs e SETs
    public Long getSeqIndicadorFinanceiro() {
        return seqIndicadorFinanceiro;
    }

    public void setSeqIndicadorFinanceiro(Long seqIndicadorFinanceiro) {
        this.seqIndicadorFinanceiro = seqIndicadorFinanceiro;
    }
