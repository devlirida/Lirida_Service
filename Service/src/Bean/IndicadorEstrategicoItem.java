...
public class IndicadorEstrategicoItem {

    private Long seqIndicadorEstrategicoItem;
    private Long seqUsuario;
    private String codigo;
    private String codigoIndicadorEstrategico;
...
// Criar GETs e SETs
    ...
    public Long getSeqIndicadorEstrategicoItem() {
        return seqIndicadorEstrategicoItem;
    }

    public void setSeqIndicadorEstrategicoItem(Long seqIndicadorEstrategicoItem) {
        this.seqIndicadorEstrategicoItem = seqIndicadorEstrategicoItem;
    }
    ...
    public String getCodigoIndicadorEstrategico() {
        return codigoIndicadorEstrategico;
    }

    public void setCodigoIndicadorEstrategico(String codigoIndicadorEstrategico) {
        this.codigoIndicadorEstrategico = codigoIndicadorEstrategico;
    }
