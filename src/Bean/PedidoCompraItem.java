...
public class PedidoCompraItem {
    ...
    private Long seqPedidoCompraItem;
    private Long seqPedidoCompra;
...
// Criar GETs e SETs
    public Long getSeqPedidoCompraItem() {
        return seqPedidoCompraItem;
    }

    public void setSeqPedidoCompraItem(Long seqPedidoCompraItem) {
        this.seqPedidoCompraItem = seqPedidoCompraItem;
    }

    public Long getSeqPedidoCompra() {
        return seqPedidoCompra;
    }

    public void setSeqPedidoCompra(Long seqPedidoCompra) {
        this.seqPedidoCompra = seqPedidoCompra;
    }
